    ...
    class TZ_Interiart{
        ...
        */
        ...
        public function  tzfrontend_scripts(){
            ...
            wp_register_script('jquery.infinitescroll.min', PLUGIN_PATH . 'assets/js/jquery.infinitescroll.min.js', false,false, $in_footer=true);
            ...
            wp_deregister_script('one_page');
            wp_register_script('one_page', PLUGIN_PATH . 'assets/js/one_page.js', false,false, $in_footer=true);
