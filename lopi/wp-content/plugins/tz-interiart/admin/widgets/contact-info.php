      ...
      ?>
          ...
          <div class="tzwidget-contact">
            ...
            <?php if($instance['interiart_email']): ?>
                ...
                <span class="tzContact_email"><i class="fa fa-envelope-o"></i><a href="mailto:<?php echo esc_html($instance['interiart_email']); ?>"><?php echo esc_html($instance['interiart_email']); ?></a></span>
