...
vc_map( array(
    ...
    "params"        => array(
        array(
            "type"          => "dropdown",
            "heading"       => __("Header Option", "js_composer"),
            "param_name"    => "tz_header_option",
            "value"         => array(
                __("General Option", "js_composer") => '1',
                __("Custom Option", "js_composer") => '2'),
        ...
        array(
            ...
            "dependency"    => Array('element' => "tz_header_option", 'value' => array('2'))
        ),
        array(
            "type"          => "dropdown",
