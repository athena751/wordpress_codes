...
function tzinteriart_header($atts) {
    $tz_header_option = $tz_header_type = $tz_logo_type = $tz_logo_image = $tz_logo_text = $tz_color_logo_text = $tz_location_menu = '';
    ...
    if($tz_header_option == '1'):
        get_template_part('template_inc/inc','header');
    else:
        wp_enqueue_script('nav');
        wp_enqueue_script('one_page');
        ...
        if ( function_exists('max_mega_menu_is_enabled') && max_mega_menu_is_enabled($tz_location_menu) ) :
                                                ...
                                                <ul>
                                                    <li>
                                                        <a class="lang_sel_sel icl-en" href="#">
                                                            <i class="fa fa-globe"></i><?php echo esc_html_e('Choose Your Languages','tz-plazart');?>
                                                        </a>
                                                        <ul>
                                                            <li class="icl-vi">
                                                                <a href="#">
            ...
            <div class="tz-headerBottom <?php echo esc_attr($tzinteriart_max_mega_menu_class);?>">
                <div class="container">
                    ...
                    <nav class="pull-right">
                        ...
                        if ($tz_location_menu != '' && has_nav_menu( $tz_location_menu )) :
                            wp_nav_menu(array(
