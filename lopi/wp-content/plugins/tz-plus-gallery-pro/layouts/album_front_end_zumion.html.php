<?php
function front_end_base_album_zumion($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                                     ...
                                     $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_zumion", plugins_url("tz-plus-gallery-pro/css/pro/zumion.css"), FALSE);
    ...
    wp_enqueue_script( 'plusgallery', plugins_url("tz-plus-gallery-pro/js/plusgallery_zumion.js"), array(), '1.0.0', true );
...
//            alert(cols );
            ...
            var all_item = jQuery('.zumion').length;
            var all_row  = Math.ceil(all_item/cols);

            jQuery('.zumion').each(function(index){
