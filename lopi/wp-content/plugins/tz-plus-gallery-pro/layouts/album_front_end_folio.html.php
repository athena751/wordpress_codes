...
function front_end_base_album_folio($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                                    ...
                                    $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_folio", plugins_url("tz-plus-gallery-pro/css/pro/folio.css"), FALSE);
    ...
    wp_enqueue_script( 'plusgallery', plugins_url("tz-plus-gallery-pro/js/plusgallery_folio.js"), array(), '1.0.0', true );
 ...
 ob_start();?>
    ...
    <style type="text/css">
        ...
        #plusgallery<?php echo esc_attr($album_ids);?> .folio .effect-folio:hover figcaption{
