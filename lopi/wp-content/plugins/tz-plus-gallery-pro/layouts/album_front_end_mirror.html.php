...
function front_end_base_album_mirror($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                                     ...
                                     $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_zumion", plugins_url("tz-plus-gallery-pro/css/pro/mirror.css"), FALSE);
    ...
    wp_enqueue_script( 'plusgallery', plugins_url("tz-plus-gallery-pro/js/plusgallery_mirror.js"), array(), '1.0.0', true );
 ...
 ob_start();?>
    ...
    <style type="text/css">
        ...
        #plusgallery<?php echo esc_attr($album_ids);?> .pgthumb{
