...
function front_end_base_album_coffee($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                                     ...
                                     $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_coffee", plugins_url("tz-plus-gallery-pro/css/pro/coffee.css"), FALSE);
    ...
    wp_enqueue_script( 'plusgallery_coffee', plugins_url("tz-plus-gallery-pro/js/plusgallery_coffee.js"), array(), '1.0.0', true );
