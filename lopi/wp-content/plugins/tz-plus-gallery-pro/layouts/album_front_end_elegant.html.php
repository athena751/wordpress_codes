<?php
function front_end_base_album_elegant($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                                      ...
                                      $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_elegant", plugins_url("tz-plus-gallery-pro/css/pro/elegant.css"), FALSE);
    ...
    wp_enqueue_script( 'plusgallery', plugins_url("tz-plus-gallery-pro/js/plusgallery_elegant.js"), array(), '1.0.0', true );
