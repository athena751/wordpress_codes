<?php
function front_end_base_album_aragon($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                                     ...
                                     $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_script( 'plusgallery', plugins_url("tz-plus-gallery-pro/js/plusgallery_aragon.js"), array(), '1.0.0', true );
