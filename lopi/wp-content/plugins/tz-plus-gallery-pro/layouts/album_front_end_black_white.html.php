...
function front_end_base_album_black_white($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                                          ...
                                          $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_black_white", plugins_url("tz-plus-gallery-pro/css/pro/black_white.css"), FALSE);
    ...
    wp_enqueue_script( 'plusgallery', plugins_url("tz-plus-gallery-pro/js/plusgallery_black_white.js"), array(), '1.0.0', true );
    ...
    $overlay = hex2rgba($options_color,0.3);
    $overlayborder = hex2rgba($options_color,0.8);
 ob_start();?>
    ...
    <style type="text/css">
        ...
        div .black_white-overlay{
            border-color:<?php echo esc_attr($overlayborder);?>;
