<?php
function front_end_base_album_rolly($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                                    ...
                                    $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_rolly", plugins_url("tz-plus-gallery-pro/css/pro/rolly.css"), FALSE);
    ...
    wp_enqueue_script( 'plusgallery', plugins_url("tz-plus-gallery-pro/js/plusgallery_rolly.js"), array(), '1.0.0', true );
 ...
 ob_start();?>
    ...
    <style type="text/css">
        ...
        #plusgallery<?php echo esc_attr($album_ids);?> .rolly-overlay{
...
<?php } ?>
    ...
    <script type="text/javascript">
        function tz_init(item_width){
            ...
            TzPlusTemplateResizeImage(jQuery('.rolly'));
        }
    </script>
