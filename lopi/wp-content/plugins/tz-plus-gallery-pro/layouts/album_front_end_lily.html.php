...
function front_end_base_album_lily($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                                   ...
                                   $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_lily", plugins_url("tz-plus-gallery-pro/css/pro/lily.css"), FALSE);
    ...
    wp_enqueue_script( 'plusgallery', plugins_url("tz-plus-gallery-pro/js/plusgallery_lily.js"), array(), '1.0.0', true );
    wp_enqueue_script( 'plusgallery_mod', plugins_url("tz-plus-gallery-pro/js/modernizr.custom.js"), array(), '1.0.0', true );
    wp_enqueue_script( 'AnimOnScroll', plugins_url("tz-plus-gallery-pro/js/AnimOnScroll.js"), array(), '1.0.0', true );
...
//            alert(cols );
            ...
            var all_item = jQuery('.lily').length;
            var all_row  = Math.ceil(all_item/cols);

            jQuery('.lily').each(function(index){
                var class_item = Math.ceil((index+1)/cols);
                jQuery(this).addClass('row'+class_item+'');
            })
    ...
    <script type="text/javascript">
        ...
        jQuery(window).bind('load resize', function() {
            ...
            if(album>0){
                TzPlusTemplateResizeImage(jQuery('.lily'));
            } else{
