...
function wp_front_end_base_album_everline($album_ids, $options_color, $options_columns, $options_padding,
                                          $options_height,  $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_aragon", plugins_url("tz-plus-gallery-pro/css/pro/everline.css"), FALSE);
    ...
    <div class="tzwpgallery plusgallery no-touch pg loaded" id="plusgallery<?php echo esc_attr($album_ids);?>">
        <ul class="clearfix tzmasonry" id="pgthumbs">
            <?php foreach($wpimages as $wpimage): ?>
                ...
                <li class="pgthumb everline">
                    <figure class="effect-folio">
                        <div class="image"><img
                                style="background: transparent url(<?php echo esc_url($wpimage->image_url);?>) no-repeat scroll 50% 50% / cover ; top: 0px; left: 0px; width: 272px; height: 272px;"
                        ...
                        <?php if($wpimage->image_title){ ?>
                            <figcaption>
                                <div class="ming-info"><h3><?php echo esc_attr($wpimage->image_title);?></h3></div>
                            </figcaption>
                        <?php } ?>
