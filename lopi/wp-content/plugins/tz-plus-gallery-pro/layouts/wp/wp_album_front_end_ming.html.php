...
function wp_front_end_base_album_ming($album_ids, $options_color, $options_columns, $options_padding,
                                      $options_height,  $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_aragon", plugins_url("tz-plus-gallery-pro/css/pro/ming.css"), FALSE);
            ...
            <?php foreach($wpimages as $wpimage): ?>
                ...
                <li class="pgthumb ming">
                    <figure class="effect-ming"><img
                        ...
                        <figcaption href="<?php echo esc_url($wpimage->image_url);?>" rel="prettyPhoto[<?php echo esc_attr($album_ids);?>]">
                            <div class="ming-info">
                                ...
                                <a  class="info pgthumbimg"
                                    ...
                                    <?php echo esc_attr($wpimage->image_title);?>
                                </a>
                                <?php } else{ ?>
                                    <a class="info pgthumbimg"
                                       href="<?php echo esc_url($wpimage->image_url);?>"
                                       rel="prettyPhoto[<?php echo esc_attr($album_ids);?>]">
                                        <?php echo esc_attr($wpimage->image_title);?>
                                    </a>
                                <?php } ?>
                            </div>
    ...
    <script type="text/javascript">
        function tz_init(){
            ...
            jQuery("figcaption[rel^='prettyPhoto']").prettyPhoto({
                social_tools:''
            });
        }
    </script>
