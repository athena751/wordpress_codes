...
function wp_front_end_base_album_pinme($album_ids, $options_color, $options_columns, $options_padding,
                                       $options_height,  $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_aragon", plugins_url("tz-plus-gallery-pro/css/pro/pinme.css"), FALSE);
    ...
    <style type="text/css">
        ...
        div .pinme .effect-folio:hover figcaption{
