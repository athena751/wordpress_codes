...
function wp_front_end_base_album_elegant($album_ids, $options_color, $options_columns, $options_padding,
                                         $options_height,  $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_aragon", plugins_url("tz-plus-gallery-pro/css/pro/elegant.css"), FALSE);
                ...
                <li class="pgthumb elegant">
                    <div class="effect3">
                        ...
                        <div class="elegant-info">
                            ...
                            <a class="image_url" href="<?php echo esc_url($wpimage->image_link);?>" <?php if($wpimage->link_target){ ?> target="_blank" <?php } ?>>
                                <i class="fa fa-link"></i>
                            </a>
                            <?php } ?>
                            <?php if($wpimage->image_title){ ?>
                            <h3><?php echo esc_attr($wpimage->image_title);?></h3>
                            <?php } ?>
                        </div>
                    </div>
                </li>
    ...
    <script type="text/javascript">
        function tz_init(){
            ...
            TzPlusTemplateResizeImage(jQuery('.elegant'));
