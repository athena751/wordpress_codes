...
function wp_front_end_base_album_lania($album_ids, $options_color, $options_columns, $options_padding,
                                       $options_height,  $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_aragon", plugins_url("tz-plus-gallery-pro/css/pro/lania.css"), FALSE);
    ...
    <div class="tzwpgallery plusgallery no-touch pg loaded" id="plusgallery<?php echo esc_attr($album_ids);?>">
        <ul class="clearfix tzmasonry" id="pgthumbs">
            <?php foreach($wpimages as $wpimage): ?>
                ...
                <li class="pgthumb lania">
                    <div class="effect3">
                        <div class="lania-overlay"></div>
                        <img
                        ...
                        <?php if($wpimage->image_title){ ?>
                            <div class="info-title"><h3><?php echo esc_attr($wpimage->image_title);?></h3></div>
                        <?php } ?>
                    </div>
                </li>
    ...
    <script type="text/javascript">
        function tz_init(){
            ...
            TzPlusTemplateResizeImage(jQuery('.lania'));
