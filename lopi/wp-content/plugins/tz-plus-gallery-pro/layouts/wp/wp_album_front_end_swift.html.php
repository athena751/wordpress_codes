...
function wp_front_end_base_album_swift($album_ids, $options_color, $options_columns, $options_padding,
                                       $options_height,  $options_album1, $desk, $tablet, $mobile)
{
    ...
    wp_enqueue_style("plusgallery_aragon", plugins_url("tz-plus-gallery-pro/css/pro/swift.css"), FALSE);
    ...
    <div class="tzwpgallery plusgallery no-touch pg loaded" id="plusgallery<?php echo esc_attr($album_ids);?>">
        <ul class="clearfix tzmasonry" id="pgthumbs">
            <?php foreach($wpimages as $wpimage): ?>
                ...
                <li class="pgthumb swift">
                    <figure class="effect3">
                        <div class="swift-overlay"></div>
                        <img
