  ...
  jQuery.fn.slideFade = function (speed, callback) {
    ...
    jQuery(''+album_class+'').animate({
      ...
      function(){
        ...
        callBack.call(this);
          jQuery('.effect-lily').each(function(){
        ...
        jQuery.each(objPath,function(i,obj){
          ...
          if(i < photo_limit) {
            ...
            pg.titleArray[i] = imgTitle;
              ...
              if(obj_click) {
                  jQuery('' + pg_ids + ' #pgthumbs').append('<li class="pgthumb lily">' +
                  ...
                  '</div>'+
                  '<div class="lily-info"> '+
                  '<a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-search"></i> </a>' +
                  ...
                  jQuery(lmnt).find('#pgthumbs').append('<li class="pgthumb lily">' +
                  '<figure class="effect-lily"  data-sr="enter top over 3s wait 0.5s">'+
                  '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                  '<figcaption>'+
                  '<div>'+
                  '<h2>' + imgTitle +'</h2>'+
