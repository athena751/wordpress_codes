  ...
  jQuery.fn.slideFade = function (speed, callback) {
    ...
    jQuery(''+album_class+'').animate({
      ...
      function(){
        ...
        callBack.call(this);
          jQuery('.effect-ming').each(function(){
...
(function (jQuery) {
    jQuery.fn.tz_init = function () {
        ...
        TzPlusTemplateResizeImage(jQuery('.ming'));
    };
        ...
        jQuery.each(objPath,function(i,obj){
          ...
          if(i < photo_limit) {
            ...
            pg.titleArray[i] = imgTitle;
              ...
              if(obj_click) {
                  jQuery('' + pg_ids + ' #pgthumbs').append('<li class="pgthumb ming">' +
                  ...
                  jQuery(lmnt).find('#pgthumbs').append('<li class="pgthumb ming">' +
                  '<figure class="effect-ming">'+
                  '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                  '<figcaption><div class="ming-info"> '+
                  '<a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"> '+ imgTitle +'</a>' +
