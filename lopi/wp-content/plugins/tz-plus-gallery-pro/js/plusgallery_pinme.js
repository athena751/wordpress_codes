        ...
        jQuery.each(objPath,function(i,obj){
          ...
          if(i < photo_limit) {
            ...
            pg.titleArray[i] = imgTitle;
              if(obj_click) {
                  jQuery('' + pg_ids + ' #pgthumbs').append('<li class="pgthumb pinme">' +
                  '<figure class="effect-folio">'+
                  '<div class="image"><img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '">' +
                  ...
                  jQuery(lmnt).find('#pgthumbs').append('<li class="pgthumb pinme">' +
                  '<figure class="effect-folio">'+
                  '<div class="image"><img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '">' +
                  '<div class="folio-btn"><a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"> </a>' +
                  '</div></div>' +
