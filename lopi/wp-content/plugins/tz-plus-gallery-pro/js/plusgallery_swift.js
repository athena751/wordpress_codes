        ...
        jQuery.each(objPath,function(i,obj){
          ...
          if(i < photo_limit) {
            ...
            pg.titleArray[i] = imgTitle;
              if(obj_click) {
                  jQuery('' + pg_ids + ' #pgthumbs').append('<li class="pgthumb swift">' +
                  '<div class="effect3"><div class="swift-overlay"></div>'+
                  '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                  '<div class="swift-info"><h3>' + imgTitle +'</h3><a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-search"></i> </a>' +
                  '<a target="_blank" href="' + imgURLLink + '" class="image_url" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-link"></i> </a>' +
                  '</div></div></li>');
              } else{
                  jQuery(lmnt).find('#pgthumbs').append('<li class="pgthumb swift">' +
                  '<div class="effect3"><div class="swift-overlay"></div>'+
                  '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                  '<div class="swift-info"><h3>' + imgTitle +'</h3><a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-search"></i> </a>' +
                  '<a target="_blank" href="' + imgURLLink + '" class="image_url" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-link"></i> </a>' +
