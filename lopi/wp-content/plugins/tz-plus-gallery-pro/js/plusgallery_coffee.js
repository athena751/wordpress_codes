        ...
        if (displayAlbum){
          ...
          if(pg.type == 'local') {
            jQuery('#pgalbums').append(
              '<li class="pgalbumthumb pgthumb coffee">' +
            ...
            jQuery(lmnt).find('#pgalbums').append(
                '<li class="pgalbumthumb pgacoffee">' +
        ...
        jQuery.each(objPath,function(i,obj){
          ...
          if(i < photo_limit) {
            ...
            pg.titleArray[i] = imgTitle;
              if(obj_click) {
                  jQuery('' + pg_ids + ' #pgthumbs').append('<li class="pgthumb coffee">' +
                  '<div class="effect3"><div class="coffee-overlay"></div>'+
                  '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '">' +
                  '<div class="corner-left"></div>'+
                  '<div class="corner-right"></div>'+
                  '<div class="corner-bottom"></div>'+
                  '<div class="coffee-info">' +
                  '<a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"><span>' + imgTitle +'</span></a>' +
                  '</div></div></li>');
              } else{
                  jQuery(lmnt).find('#pgthumbs').append('<li class="pgthumb coffee">' +
                  '<div class="effect3"><div class="coffee-overlay"></div> '+
                  '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '">' +
                  '<div class="corner-left"></div>'+
                  '<div class="corner-right"></div>'+
