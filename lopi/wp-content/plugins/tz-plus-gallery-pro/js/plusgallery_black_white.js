        ...
        if (displayAlbum){
          ...
          if(pg.type == 'local') {
            jQuery('#pgalbums').append(
              '<li class="pgalbumthumb pgthumb black_white">' +
            ...
            jQuery(lmnt).find('#pgalbums').append(
                '<li class="pgalbumthumb pgablack_white">' +
        ...
        jQuery.each(objPath,function(i,obj){
          ...
          if(i < photo_limit) {
            ...
            pg.titleArray[i] = imgTitle;
              if(obj_click) {
                  jQuery('' + pg_ids + ' #pgthumbs').append('<li class="pgthumb black_white">' +
                  '<div class="effect3"><div class="black_white-overlay"></div>'+
                  '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '">' +
                  '<div class="black_white-info"><a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '">' + imgTitle +'</a>' +
                  '<h3>' + imgTitle +'</h3></div></div></li>');
              } else{
                  jQuery(lmnt).find('#pgthumbs').append('<li class="pgthumb black_white">' +
                  '<div class="effect3"><div class="black_white-overlay"></div>'+
                  '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '">' +
                  '<div class="black_white-info"><a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '">' + imgTitle +'</a>' +
                  '</div></div></li>');
