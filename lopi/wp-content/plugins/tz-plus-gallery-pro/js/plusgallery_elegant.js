        ...
        if (displayAlbum){
          ...
          if(pg.type == 'local') {
            jQuery('#pgalbums').append(
              '<li class="pgalbumthumb pgthumb elegant">' +
            ...
            jQuery(lmnt).find('#pgalbums').append(
                '<li class="pgalbumthumb pgaelegant">' +
        ...
        jQuery.each(objPath,function(i,obj){
          ...
          if(i < photo_limit) {
            ...
            pg.titleArray[i] = imgTitle;
              if(obj_click) {
                  jQuery('' + pg_ids + ' #pgthumbs').append('<li class="pgthumb elegant">' +
                  '<div class="effect3"><div class="elegant-overlay"></div>'+
                  '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '">' +
                  '<div class="elegant-info"><a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-search"></i> </a>' +
                  ...
                  jQuery(lmnt).find('#pgthumbs').append('<li class="pgthumb elegant">' +
                  '<div class="effect3"><div class="elegant-overlay"></div>'+
                  '<img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '">' +
                  '<div class="elegant-info"><a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-search"></i> </a>' +
                  '<a target="_blank" href="' + imgURLLink + '" class="image_url" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-link"></i> </a>' +
