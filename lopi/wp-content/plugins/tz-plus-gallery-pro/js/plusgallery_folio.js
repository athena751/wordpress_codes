  ...
  jQuery.fn.slideFade = function (speed, callback) {
    ...
    jQuery(''+album_class+'').animate({
      ...
      function(){
        ...
        callBack.call(this);
          jQuery('.effect-folio').each(function(){
              var theImage = new Image();
              theImage.src = jQuery(this).find('img').attr('src');
              var imageWidth = theImage.width;
              var imageHeight = theImage.height;
              var imgsl = imageWidth/imageHeight;
              //console.log(imgsl);
              if(imgsl <0.85){
                  jQuery(this).parent().addClass('item_height2');
              }
              if(imgsl >2){
                  jQuery(this).parent().addClass('item_width2');
              }
          })
...
(function (jQuery) {
    jQuery.fn.tz_init = function () {
        ...
        TzPlusTemplateResizeImage(jQuery('.folio .image'));
    };
  ...
  jQuery.fn.plusGallery = function(options){
    ...
    var pg = {
      ...
      _doc.off('click').on("click", ".pgalbumlink",function(e){
          ...
          var galleryTitle = jQuery(this).parent().find('.pgalbumtitle').html();
        ...
        _doc.on('click','.pgthumbimg',function(e){
          e.preventDefault();
          var idx = jQuery(this).parent().parent().parent().parent().index();
          obj = jQuery(this);
          pg.loadZoom(idx,obj);
        });
        ...
        if (displayAlbum){
          ...
          if(pg.type == 'local') {
            jQuery('#pgalbums').append(
              '<li class="pgalbumthumb pgthumb folio">' +
            ...
            jQuery(lmnt).find('#pgalbums').append(
                '<li class="pgalbumthumb pgafolio">' +
        ...
        jQuery.each(objPath,function(i,obj){
          ...
          if(i < photo_limit) {
            ...
            pg.titleArray[i] = imgTitle;
              if(obj_click) {
                  jQuery('' + pg_ids + ' #pgthumbs').append('<li class="pgthumb folio">' +
                  '<figure class="effect-folio">'+
                  '<div class="image"><img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                  '<div class="folio-btn"><a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-search"></i> </a>' +
                  '<a target="_blank" href="' + imgURLLink + '" class="image_url" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-link"></i> </a>' +
                  '</div></div>' +
                  '<figcaption><div class="ming-info"> '+
                  '<h2>' + imgTitle +'</h2>'+
                  '</div>'+
                  '</figcaption>'+
                  '</figure>'+
                  ...
                  jQuery(lmnt).find('#pgthumbs').append('<li class="pgthumb folio">' +
                  '<figure class="effect-folio">'+
                  '<div class="image"><img data-src="' + imgSrc + '" src="' + imgTh + '" id="pgthumbimg' + i + '" class="" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '>' +
                  '<div class="folio-btn"><a data-src="' + imgSrc + '" href="' + imgSrc + '" class="info pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-search"></i> </a>' +
                  '<a target="_blank" href="' + imgURLLink + '" class="image_url" alt="' + imgTitle + '" title="' + imgTitle + '"><i class="fa fa-link"></i> </a>' +
      ...
      loadZoom: function(idx,obj){
        pg.zoomIdx = idx;
        pg.winWidth = jQuery(window).width();
        var id_pagezoom = obj.parent().parent().parent().parent().parent().parent().parent().attr('id');
        ...
        pgZoomView.addClass(id_pagezoom);
          ...
          obj.parent().parent().parent().parent().parent().find('.pgthumbimg').each(function(index){
