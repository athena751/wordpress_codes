<?php
/*
Plugin Name: TZ PlusGallery Pro
Plugin URI: http://templaza.com
Description: TZ PlusGallery get your album from your facebook, Google plus, Flickr, Instagram and WordPress gallery.
Version: 1.5
Author: templaza
...
define( 'TZ_PLUS_GALLERY_PRO_DIR', plugin_dir_path( __FILE__ ) );
require 'plugin-updates/plugin-update-checker.php';
$ExampleUpdateChecker = PucFactory::buildUpdateChecker(
    'https://raw.githubusercontent.com/tuyencntt/tz-plus-gallery-pro/master/info.json',
    __FILE__
);
...
{
    $page_cat = add_menu_page('Theme page title', 'TZ PlusGallery<strong style="color:#ff1c1c; position: absolute; font-size:12px; top:-2px; right:10px; font-style: italic">pro</strong>', 'delete_pages', 'tz_plusgallery', 'tz_plusgallery', plugins_url('images/tzsidebar.png', __FILE__));
...
function tz_gallery_addto_header() {
    ...
    <script type="text/javascript">
        var imgpath = "<?php echo plugins_url();?>/tz-plus-gallery-pro/";
    </script>
<?php
}
...
function tz_plusgallery_style(){
    ...
    wp_enqueue_style("font-awesome.min", plugins_url("css/pro/font-awesome.min.css", __FILE__), FALSE);
...
function   tz_plusgallery_list($id)
{
    ...
    foreach ($albums_options as $row_options) {
        ...
        $options_layouts    = $row_options->options_layouts;
        $options_nav        = $row_options->options_nav;
        $options_height     = $row_options->options_css;
        $options_res        = $row_options->options_width;
        $options_album1     = $row_options->options_album1;
        $respon_arr         = explode(',',$options_res);
        $desk               = $respon_arr[0];
        $tablet             = $respon_arr[1];
        $mobile             = $respon_arr[2];
    }
    ...
    $directory = "" . $theme_part . "/tz-plus-gallery-pro/";
    $directory_plg = TZ_PLUS_GALLERY_PRO_DIR."/tpl_views/";
    $tzplus_theme_layout = glob($directory . "*.php");
    $tzplus_plg_layout = glob($directory_plg . "*.php");

    if($album_type=='wordpress'){
        switch($options_layouts)
        {
            case "aragon":
                require_once("layouts/wp/wp_album_front_end_aragon.html.php");
                return wp_front_end_base_album_aragon($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "black_white":
                require_once("layouts/wp/wp_album_front_end_black_white.html.php");
                return wp_front_end_base_album_black($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "coffee":
                require_once("layouts/wp/wp_album_front_end_coffee.html.php");
                return wp_front_end_base_album_coffee($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "elegant":
                require_once("layouts/wp/wp_album_front_end_elegant.html.php");
                return wp_front_end_base_album_elegant($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "everline":
                require_once("functions/plusgallery_functions.php");
                require_once("layouts/wp/wp_album_front_end_everline.html.php");
                return wp_front_end_base_album_everline($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "folio":
                require_once("functions/plusgallery_functions.php");
                require_once("layouts/wp/wp_album_front_end_folio.html.php");
                return wp_front_end_base_album_folio($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "lania":
                require_once("layouts/wp/wp_album_front_end_lania.html.php");
                return wp_front_end_base_album_lania($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "lily":
                require_once("layouts/wp/wp_album_front_end_lily.html.php");
                return wp_front_end_base_album_lily($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "ming":
                require_once("layouts/wp/wp_album_front_end_ming.html.php");
                return wp_front_end_base_album_ming($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "mirror":
                require_once("layouts/wp/wp_album_front_end_mirror.html.php");
                return wp_front_end_base_album_mirror($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "pinme":
                require_once("functions/plusgallery_functions.php");
                require_once("layouts/wp/wp_album_front_end_pinme.html.php");
                return wp_front_end_base_album_pinme($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "rolly":
                require_once("functions/plusgallery_functions.php");
                require_once("layouts/wp/wp_album_front_end_rolly.html.php");
                return wp_front_end_base_album_rolly($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "simple":
                require_once("layouts/wp/wp_album_front_end_simple.html.php");
                return wp_front_end_base_album_simple($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "swift":
                require_once("layouts/wp/wp_album_front_end_swift.html.php");
                return wp_front_end_base_album_swift($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            case "zumion":
                require_once("layouts/wp/wp_album_front_end_zumion.html.php");
                return wp_front_end_base_album_zumion($album_ids, $options_color, $options_columns, $options_padding,
                    $options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
            default:
                return wp_front_end_base_album($album_ids,$options_color,$options_columns,$options_padding,$options_height,  $options_album1, $desk, $tablet, $mobile);
                break;
    ...
    if($album_type !='wordpress') {
        ...
        {
            case "zumion":
                require_once("layouts/album_front_end_zumion.html.php");
                return front_end_base_album_zumion($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                ...
                break;
            case "mirror":
                require_once("layouts/album_front_end_mirror.html.php");
                return front_end_base_album_mirror($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "rolly":
                require_once("functions/plusgallery_functions.php");
                require_once("layouts/album_front_end_rolly.html.php");
                return front_end_base_album_rolly($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "ming":
                require_once("functions/plusgallery_functions.php");
                require_once("layouts/album_front_end_ming.html.php");
                return front_end_base_album_ming($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "lily":
                require_once("functions/plusgallery_functions.php");
                require_once("layouts/album_front_end_lily.html.php");
                return front_end_base_album_lily($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "folio":
                require_once("functions/plusgallery_functions.php");
                require_once("layouts/album_front_end_folio.html.php");
                return front_end_base_album_folio($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "everline":
                require_once("functions/plusgallery_functions.php");
                require_once("layouts/album_front_end_everline.html.php");
                return front_end_base_album_everline($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "lania":
                require_once("layouts/album_front_end_lania.html.php");
                return front_end_base_album_lania($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "swift":
                require_once("layouts/album_front_end_swift.html.php");
                return front_end_base_album_swift($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "aragon":
                require_once("layouts/album_front_end_aragon.html.php");
                return front_end_base_album_aragon($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "elegant":
                require_once("layouts/album_front_end_elegant.html.php");
                return front_end_base_album_elegant($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "pinme":
                require_once("functions/plusgallery_functions.php");
                require_once("layouts/album_front_end_pinme.html.php");
                return front_end_base_album_pinme($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "simple":
                require_once("layouts/album_front_end_simple.html.php");
                return front_end_base_album_simple($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "black_white":
                require_once("functions/plusgallery_functions.php");
                require_once("layouts/album_front_end_black_white.html.php");
                return front_end_base_album_black_white($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            case "coffee":
                require_once("layouts/album_front_end_coffee.html.php");
                return front_end_base_album_coffee($album_ids, $album_name, $album_type, $album_id, $album_data_type, $album_single_id, $album_include,
                    $album_exclude, $album_limit, $album_single_limit, $options_color, $options_columns, $options_padding, $options_height, $options_nav,
                     $options_album1, $desk, $tablet, $mobile);
                break;
            default:
...
<form action="" method="post" name="adminForm" id="adminForm">
 <?php 	if (count($shortcodesliders)) {
    echo "<select id='tz_plus_gallery_select' name='tz_plus_gallery_pro'>";
    foreach ($shortcodesliders as $shortcodeslider) {
        $selected='';
        if($shortcodeslider->id == $_POST["tz_plus_gallery_pro"]){$selected='selected="selected"';}
    ...
    echo "No Album found", "tz_plusgallery";}
    ?>
