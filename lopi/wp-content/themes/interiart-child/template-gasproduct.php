<?php
/*
 * Template Name: Template Gasproduct Page
 */
?>
<?php
    get_header();
        ...
        <ul>
               ...
               foreach ( $termchildren as $child ) {
                $term = get_term_by( 'id', $child, $taxonomy_name ); ?>
                                ...
                                <li>
                                    <div class="plus-icon">
                                        <a href="<?php get_term_link( $child, $taxonomy_name );  ?>" title="<?php echo $term->name; ?>"><i class="fa fa-plus fa-2x" aria-hidden="true"></i></a>
                                    </div>
                                    <h6>
