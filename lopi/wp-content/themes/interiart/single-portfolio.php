<?php
$interiart_media      = ot_get_option('interiart_TzSinglePortfolio_Media','show');
$interiart_title      = ot_get_option('interiart_TzSinglePortfolio_Title','show');
$interiart_content    = ot_get_option('interiart_TzSinglePortfolio_content','show');
$interiart_author     = ot_get_option('interiart_TzSinglePortfolio_author','show');
$interiart_date       = ot_get_option('interiart_TzSinglePortfolio_date','show');
$interiart_category   = ot_get_option('interiart_TzSinglePortfolio_category','show');
$interiart_tag        = ot_get_option('interiart_TzSinglePortfolio_tag','show');
?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 tzPortfolio_Single_Info">
                        <ul>
                            ...
                            <?php
                            if(get_the_terms($post -> ID,'portfolio-category') != false && $interiart_category == 'show') {
                                ?>
                                    <li>
                            ...
                            <?php
                            if(get_the_terms($post -> ID,'portfolio-tags') != false && $interiart_tag == 'show') {
                                ?>
                                <li>
