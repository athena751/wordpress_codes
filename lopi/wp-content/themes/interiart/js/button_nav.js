(function (d, c, a, e) {
    ...
    b.prototype = {defaults: {navItems: "a", currentClass: "current", changeHash: false, easing: "swing", filter: "", scrollSpeed: 750, scrollThreshold: 0.5, begin: false, end: false, scrollChange: false}, init: function () {
        ...
        this.$nav.on("click.onePageNav_btn", d.proxy(this.handleClick, this));
        this.getPositions();
        this.bindInterval();
        this.$win.on("resize.onePageNav_btn", d.proxy(this.getPositions, this));
        return this
        ...
        var g = this;
        var f;
        g.$win.on("scroll.onePageNav_btn", function () {
        ...
        d("html, body").animate({scrollTop: g-30}, this.config.scrollSpeed, this.config.easing, h)
    }, unbindInterval: function () {
        clearInterval(this.t);
        this.$win.unbind("scroll.onePageNav_btn")
    }};
    b.defaults = b.prototype.defaults;
    d.fn.onePageNav_btn = function (f) {
