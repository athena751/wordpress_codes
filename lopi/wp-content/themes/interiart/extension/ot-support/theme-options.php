...
function interiart_theme_options()
{
    ...
    $interiart_custom_settings = array(
        ...
        'sections'        => array(
            ...
            array(
                'id'    => 'rtl',
                'title' =>  esc_html__('Right To Left Option', 'interiart'),
            ),
            array(
                'id'    =>  'TZThemecolor',
        ...
        'settings'        => array(
            ...
            *  Option Right To Left
            ...
            array(
                'id'        =>  'interiart_rtl',
                'label'     =>   esc_html__('Right To Left Option', 'interiart'),
                'desc'      =>  '',
                'std'       =>  '0',
                'type'      =>  'select',
                'section'   =>  'rtl',
                'choices'   =>  array(
                    array(
                        'value' =>  '0',
                        'label' =>   esc_html__('Left To Right', 'interiart'),
                    ),
                    array(
                        'value' =>  '1',
                        'label' =>   esc_html__('Right To Left', 'interiart'),
                    )
                ),
            ),
            ...
            *  footer option
            ...
            array(
                'id'    =>  'interiart_TzFooter_instagram',
                'label' =>   esc_html__('Instagram Url', 'interiart'),
                'desc'  =>   esc_html__('', 'interiart'),
                'std'   =>  '',
                'type'  =>  'text',
                'section'=> 'footeroptiontype1',
            ...
            array(
                'id'    =>  'interiart_TzFooterType2_instagram',
                'label' =>   esc_html__('Ín Url', 'interiart'),
                'desc'  =>   esc_html__('', 'interiart'),
                'std'   =>  '',
                'type'  =>  'text',
                'section'=> 'footeroptiontype2',
            ...
            array(
                'id'        => 'interiart_tzBreadcrumb404_Imagebg',
                'label'     =>  esc_html__('Image Background Breadcrumb Of 404 Page ','interiart'),
                'desc'      =>  esc_html__('Please choose an image  to upload. If you do not choose image here, Background Section will receive option Image Background General in Theme Options / Breadcrumb Option ','interiart'),
            ...
            array(
                'id'    =>  'interiart_TzHeaderTop_Phone',
                'label' =>   esc_html__('Phone', 'interiart'),
                'desc'  =>   esc_html__('Import Phone contact.Ex: xxxx xxx xxx', 'interiart'),
                'std'   =>  '',
                'type'  =>  'text',
                'section'=> 'TzHeaderTopOption'
            ),
            ...
            array(
                'id'    =>  'interiart_TzHeaderTop_instagram',
                'label' =>   esc_html__('Instagram Url', 'interiart'),
                'desc'  =>   esc_html__('', 'interiart'),
                'std'   =>  '',
                'type'  =>  'text',
            ...
            array(
                ...
                'label'     =>  esc_html__('Image Background General ','interiart'),
                'desc'      =>  esc_html__('This is general option to upload image of section.Please choose an image  to upload.','interiart'),
                'std'       => $interiart_breadcrumb,
                'type'      => 'upload',
                'section'   => 'TzBreadcrumbOption',
            ),
            ...
            array(
                'id'        => 'interiart_tzBreadcrumbBlog_Imagebg',
                'label'     =>  esc_html__('Image Background Breadcrumb Of Blog Page ','interiart'),
                'desc'      =>  esc_html__('Please choose an image  to upload. If you do not choose image here, Background Section will receive option Image Background General in Theme Options / Breadcrumb Option ','interiart'),
                'std'       => $interiart_breadcrumb,
                'type'      => 'upload',
            ...
            array(
                'id'        => 'interiart_tzBreadcrumbSinglePost_Imagebg',
                'label'     =>  esc_html__('Image Background Breadcrumb Of Single Post ','interiart'),
                'desc'      =>  esc_html__('Please choose an image  to upload. If you do not choose image here, Background Section will receive option Image Background General in Theme Options / Breadcrumb Option ','interiart'),
                'std'       => $interiart_breadcrumb,
                'type'      => 'upload',
            ...
            array(
                'id'        => 'interiart_tzBreadcrumbShop_Imagebg',
                'label'     =>  esc_html__('Image Background Breadcrumb Of Shop Page ','interiart'),
                'desc'      =>  esc_html__('Please choose an image  to upload. If you do not choose image here, Background Section will receive option Image Background General in Theme Options / Breadcrumb Option ','interiart'),
                'std'       => $interiart_breadcrumb,
                'type'      => 'upload',
                'section'   => 'tzShopOption',
            ...
            array(
                'id'        =>  'interiart_TzBlog_Product_Height_Option',
                'label'     =>   esc_html__('Height Product Option', 'interiart'),
                'desc'      =>   esc_html__('You can choose height product auto or fix.', 'interiart'),
                'std'       =>  'fix',
                'type'      =>  'select',
                'section'   =>  'tzShopOption',
                'rows'      =>  '',
                ...
                'choices'   =>  array(
                    array(
                        'value' =>  'fix',
                        'label' =>   esc_html__('Fix Height', 'interiart'),
                    ),
                    array(
                        'value' =>  'auto',
                        'label' =>   esc_html__('Auto Height', 'interiart'),
                    ),
                ),
            ),
            ...
            array(
                'id'        => 'interiart_tzBreadcrumbShopDetail_Imagebg',
                'label'     =>  esc_html__('Image Background Breadcrumb Of Shop Detail ','interiart'),
                'desc'      =>  esc_html__('Please choose an image  to upload. If you do not choose image here, Background Section will receive option Image Background General in Theme Options / Breadcrumb Option ','interiart'),
                'std'       => $interiart_breadcrumb,
                'type'      => 'upload',
                'section'   => 'tzShopDetailOption',
