...
if(!is_admin()):
    ...
    function interiart_config_theme(){
        ...
        $interiart_breadcrumb_image_shop                    = ot_get_option('interiart_tzBreadcrumbShop_Imagebg');
        $interiart_breadcrumb_image_shop_detail             = ot_get_option('interiart_tzBreadcrumbShopDetail_Imagebg');
        $interiart_breadcrumb_image_blog                    = ot_get_option('interiart_tzBreadcrumbBlog_Imagebg');
        $interiart_breadcrumb_image_single_post             = ot_get_option('interiart_tzBreadcrumbSinglePost_Imagebg');
        $interiart_breadcrumb_image_page                    = get_post_meta( get_the_ID(),'interiart_imagebg_breadcrumb_page', true );
        $interiart_breadcrumb_image_general                 = ot_get_option('interiart_tzBreadcrumb_Imagebg');

        $interiart_breadcrumb  = '';
        if( class_exists('WooCommerce') && ( is_shop() || is_product_category() )){
            if($interiart_breadcrumb_image_shop != ''){
                $interiart_breadcrumb = '.tz-Breadcrumb {background-image:url('.esc_attr($interiart_breadcrumb_image_shop).')!important;}';
            }elseif($interiart_breadcrumb_image_general != ''){
                $interiart_breadcrumb = '.tz-Breadcrumb {background-image:url('.esc_attr($interiart_breadcrumb_image_general).')!important;}';
            }
        }elseif ( class_exists('WooCommerce') && is_product()) {
            if($interiart_breadcrumb_image_shop_detail != ''){
                $interiart_breadcrumb = '.tz-Breadcrumb {background-image:url('.esc_attr($interiart_breadcrumb_image_shop_detail).')!important;}';
            }elseif($interiart_breadcrumb_image_general != ''){
                $interiart_breadcrumb = '.tz-Breadcrumb {background-image:url('.esc_attr($interiart_breadcrumb_image_general).')!important;}';
            }
        }elseif(is_category() || is_author() || is_search() || is_tag() || is_archive()) {
            if($interiart_breadcrumb_image_blog != ''){
                $interiart_breadcrumb = '.tz-Breadcrumb {background-image:url('.esc_attr($interiart_breadcrumb_image_blog).')!important;}';
            }elseif($interiart_breadcrumb_image_general != ''){
                $interiart_breadcrumb = '.tz-Breadcrumb {background-image:url('.esc_attr($interiart_breadcrumb_image_general).')!important;}';
            }
        }elseif(is_singular( 'post' )){
            if($interiart_breadcrumb_image_single_post != ''){
                $interiart_breadcrumb = '.tz-Breadcrumb {background-image:url('.esc_attr($interiart_breadcrumb_image_single_post).')!important;}';
            }elseif($interiart_breadcrumb_image_general != ''){
                $interiart_breadcrumb = '.tz-Breadcrumb {background-image:url('.esc_attr($interiart_breadcrumb_image_general).')!important;}';
            }
        }elseif(is_page()){
            if($interiart_breadcrumb_image_page != ''){
                $interiart_breadcrumb = '.tz-Breadcrumb {background-image:url('.esc_attr($interiart_breadcrumb_image_page).')!important;}';
            }elseif($interiart_breadcrumb_image_general != ''){
                $interiart_breadcrumb = '.tz-Breadcrumb {background-image:url('.esc_attr($interiart_breadcrumb_image_general).')!important;}';
            }
        }else{
            if($interiart_breadcrumb_image_general != ''){
                $interiart_breadcrumb = '.tz-Breadcrumb {background-image:url('.esc_attr($interiart_breadcrumb_image_general).')!important;}';
            }
        }
