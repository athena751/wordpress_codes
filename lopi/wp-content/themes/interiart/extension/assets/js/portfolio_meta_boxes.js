...
jQuery(function(){
  ...
  var $checkpage = jQuery('#page_template').val();
    switch ($checkpage){
        case 'template-portfolio.php':
            ...
            jQuery('#under_construction_meta_box').css('display','none');
            break;
        ...
        case 'template-under-construction.php':
            ...
            jQuery('#page_blog_meta_box').css('display','none');
            jQuery('#blogColumn_meta_box').css('display','none');
            jQuery('#under_construction_meta_box').css('display','block');
            break
        default :
            jQuery('#page_meta_box').css('display','none');
            jQuery('#page_blog_meta_box').css('display','none');
  ...
  jQuery('#page_template').change(function(){
    ...
    var $checkpage_breadcrumb_val = jQuery('#page_template').val();
    switch ($checkpage_breadcrumb_val){
        case 'template-homepage.php':
            jQuery('#page_breadcrumb_meta_box').css('display','none');
            break;
        case 'template-under-construction.php':
            jQuery('#page_breadcrumb_meta_box').css('display','none');
            break
        default :
            jQuery('#page_breadcrumb_meta_box').css('display','block');
            break;
    }

    jQuery('#page_template').change(function(){
        var $check_breadcrumb_change = jQuery(this).val();
        switch ($check_breadcrumb_change){
            case 'template-homepage.php':
                jQuery('#page_breadcrumb_meta_box').css('display','none');
                break;
            case 'template-under-construction.php':
