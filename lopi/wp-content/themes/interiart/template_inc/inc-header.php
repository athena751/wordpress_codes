<?php
    ...
    $interiart_phone          = ot_get_option('interiart_TzHeaderTop_Phone');
    ...
    $interiart_instagram      = ot_get_option('interiart_TzHeaderTop_instagram');
                        ...
                        <div class="tzheader_support">
                            ...
                            if($interiart_email != ''){
                                ...
                                <div class="tzheader_site">
                                    ...
                                    <a href="mailto:<?php echo esc_html($interiart_email);?>"><?php echo esc_html($interiart_email);?></a>
                                </div>
                            <?php
                            }
                            ?>
                            ...
                            if($interiart_email != ''){
                                ...
                                <div class="tzheader_site">
                                    ...
                                    <?php echo esc_html($interiart_phone);?>
                                </div>
                            <?php
                            }
                            ?>
